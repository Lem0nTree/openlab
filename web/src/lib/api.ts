...
export type LabSettings = { id: string; name: string; units: "metric" | "imperial" };
...
export type McpIntegration = { enabled: boolean; direct_transport: "https" | "ssh_stdio"; public_url: string | null; grants: McpGrant[] };
